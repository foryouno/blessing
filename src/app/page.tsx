...
export default function VideoGenerator() {
  ...
  const [imageTalkVideoPrompt, setImageTalkVideoPrompt] = useState('一位专业的数字人正在认真朗读稿件，表情自然，语速适中，眼神专注，吐字清晰，专业的播读风格');
  ...
  const splitTextIntoSegments = (text: string, maxDurationPerSegment: number = 12): string[] => {
...
📝 内容：${text.substring(0, 30)}...`;
  ...
  // 图片说话功能：自动计算时长
  useEffect(() => {
    if (imageTalkAutoDuration && imageTalkVoiceText.trim()) {
      const autoDuration = calculateValidDurationFromText(imageTalkVoiceText);
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-6 bg-slate-800/50 backdrop-blur border-purple-500/20">
            <div className="space-y-6">
                ...
                <TabsContent value="image-gen" className="mt-4">
                  <div className="space-y-6">
                    ...
                    <Button
                      ...
                      className="w-full py-6 text-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isGeneratingImage ? (
                        <span className="flex items-center gap-2">
                          <Loader2 className="w-5 h-5 animate-spin" />
              ...
              {(activeTab === 'text' || activeTab === 'images' || activeTab === 'avatar') && (
              ...
              {(activeTab === 'text' || activeTab === 'images' || activeTab === 'avatar') && model !== 'doubao-seed-tts' && (
                <div className="flex items-center gap-3">
                  <Switch
                    id="audio"
